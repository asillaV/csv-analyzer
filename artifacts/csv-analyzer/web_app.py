...
def render_header():
    ...
    st.markdown(
        ...
        <style>
          ...
          .eng-spacer {{ flex: 1; }}
          .eng-links {{ display: flex; gap: 8px; }}
          .eng-link {{
            color: #475569;
          ...
          .eng-link:hover {{ color: #10b981; border-color: #10b981; }}
        ...
        <div class="eng-topbar">
          ...
          <span class="eng-links">
            <a class="eng-link" href="https://buymeacoffee.com/asillav" target="_blank" rel="noopener">&#9749; coffee</a>
            <a class="eng-link" href="https://asillav.github.io/" target="_blank" rel="noopener">&#128025; github</a>
          </span>
        </div>
        """,
        unsafe_allow_html=True,
